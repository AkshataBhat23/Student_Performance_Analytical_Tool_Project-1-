...
model = joblib.load(r"C:\Users\aksha\Downloads\archive (1)\VS Code\rf_model.pkl")
with open(r"C:\Users\aksha\Downloads\archive (1)\VS Code\model_features.json") as f:
